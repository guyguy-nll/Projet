...
public class Connexion {
    ...
    public Connexion(String nameDatabase, String loginDatabase, String passwordDatabase) throws SQLException, ClassNotFoundException {
        ...
        //String sql = "INSERT INTO sqltest" + "VALUES ('Jean','Dupont')";
        //String sql = "SELECT * FROM sqltest";
      /*  String nom = "Thirard";
        String prenom = "Melissa";
        String sql = "INSERT INTO sqltest VALUES ('" + nom + "','" + prenom + "');";
        String sql2 = "SELECT * FROM sqltest";
        ...
        //stmt.executeUpdate(sql);//"INSERT INTO sqltest(nom, prenom) VALUES ("+nom+","+prenom+")");

        System.out.println("pas identifie");
